...
const Header = ({ name }) => {
  ...
  return (
    ...
    >
      ...
      <motion.div className="relative px-4 md:px-12 mx-auto max-w-7xl z-10" variants={containerVariants}>
        <div className="w-full mx-auto md:w-11/12 xl:w-9/12 text-center">
          <motion.h1 
            className="mb-8 text-4xl font-extrabold leading-tight tracking-normal text-slate-50 md:text-6xl md:tracking-tight"
            variants={itemVariants}
          >
            <motion.span className="block" variants={itemVariants}>Watch</motion.span>
            <motion.span className="block py-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600 animate-gradient" variants={itemVariants}>
              your favorite crypto
            </motion.span>
            <motion.span className="block" variants={itemVariants}>in real time, here.</motion.span>
          </motion.h1>
          <motion.p 
