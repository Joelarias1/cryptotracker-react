...
const Header = () => {
  ...
  return (
    <motion.header
      className="flex flex-col sm:flex-row items-center justify-center min-h-screen bg-zinc-850"
      initial="hidden"
      animate={controls}
      variants={motionVariants}
    >
      <div className="text-start sm:w-1/2 px-5 sm:p-10">
        ...
        <div className="mt-6 flex justify-start">
          <Button
            href="#"
            className="rounded-2xl bg-blue-700 px-8 sm:px-16 py-3 font-medium text-white mt-2 button-hover"
            ripple="light"
          >
            Get started
          </Button>
      ...
      <div className="sm:w-1/2">
        <Lottie animationData={animation} className="mx-2"/>
      </div>
    </motion.header>
  );
};
